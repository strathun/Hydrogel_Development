%% experiment_cellImpedance_overTime_start20220213
...
figure
for ii = 1:length(gamryStructure_EIS_cell_Day05)
    loglog( gamryStructure_EIS_cell_Day05(ii).Zreal, ...
            -1*gamryStructure_EIS_cell_Day05(ii).Zim, '.' )
    hold on
end
xlabel('Zreal')
ylabel('Zim')
...
for ii = 1:length(gamryStructure_EIS_cell_Day05)
    loglog( gamryStructure_EIS_cell_Day05(ii).f, ...
            gamryStructure_EIS_cell_Day05(ii).Zreal, '.' )
    hold on
end
ylabel('Zreal')
legend('CM-r1', 'CM-r2', 'Gel 01', 'Gel 02', 'Gel 03', 'Gel 04','Gel 05', 'Gel 06')
...
% 01/20
pointerArray = [3 4 5 6 7]; %skipping gel 6 this day
numMeasures = length(pointerArray);
for ii = 1:numMeasures
    jj = pointerArray(ii);
    meanArray = [meanArray gamryStructure_EIS_cell_Day02(jj).Zmag];
...
% 01/20 
pointerArray = [1]; %skipping second CM run this day
numMeasures = length(pointerArray);
for ii = 1:numMeasures
    jj = pointerArray(ii);
    meanArray = [meanArray gamryStructure_EIS_cell_Day02(jj).Zmag];
...
ylabel('Phase')
xlim([9.9 1e6])
legend('Cells Day 01', 'Cells Day 02', 'Cells Day 03', 'Cells Day 04', 'Cells Day 05',...
       'CM')
